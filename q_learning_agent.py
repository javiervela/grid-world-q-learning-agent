...
if __name__ == "__main__":
    ...
    parser.add_option(
        ...
        dest="numEpisodes",
        type="int",
        help="Número de episodios a realizar (50 por defecto)",
        default=50,
    )
    parser.add_option(
        "-n",
        ...
        dest="noise",
        type="float",
        help="Probabilidad de que el movimiento no sea el realizado, en tanto por uno (0.0 por defecto)",
        default=0.0,
    )
    parser.add_option(
        "-s",
        ...
        dest="skip",
        action="store_true",
        help="Saltar la visualización durante el aprendizaje",
        default=False,
    )
